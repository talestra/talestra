...
namespace Brave
{
	public class Script
	{
		...
		public struct Instruction
		{
			...
			{
				var Out = String.Format("{0:X8}({1:X4}): {2}({3})", Position, Opcode.OpcodeNum, Opcode.OpcodeName, String.Join(", ", Parameters.Select(Parameter => Serialize(Parameter))));
				Out = (new String(' ', Indent * 4)) + Out;
				return Out;
			}
		}
		...
		public IEnumerable<Instruction> ParseAll()
		{
			...
			{
				yield return ParseSingle(ParseState);
			}
		}
		...
		{
			public int Indent = 0;
			public HashSet<uint> Unindent = new HashSet<uint>();
		}
		...
		static Script()
		{
			...
			AddOpcode(0x04, "JUMP_ALWAYS", "L");
			AddOpcode(0x05, "BLOCK_ENDIF", "<4");
			AddOpcode(0x07, "ENABLE_PLAY", "");
			...
			AddOpcode(0x28, "BACKGROUND_SET_IMAGE", "s");
			AddOpcode(0x29, "OP_29", "PPs");
			AddOpcode(0x2A, "BACKGROUND_SET_COLOR", "4");
			AddOpcode(0x2B, "OP_2B", "4");
			AddOpcode(0x2C, "OP_2C", "4");
			AddOpcode(0x2D, "SET_BACKGROUND_EFFECT", "P");
			AddOpcode(0x2E, "OP_2E", "-");
			AddOpcode(0x2F, "TEXT_PUT", "<sss");
			AddOpcode(0x30, "TRANSITION", "<P");
			...
			AddOpcode(0x80, "CHARA_SET_SPECIAL_ANIMATION", "PP");
			...
			AddOpcode(0x8B, "CHARA_EMOJI", "PPP");
