...
namespace Brave
{
	public class Script
	{
		...
		public struct LabelReference
		{
			...
			public override string ToString()
			{
				return String.Format("LabelReference(0x{0:X8})", Offset);
			}
		}
		...
		static Script()
		{
			...
			AddOpcode(0x48, "OP_48", "s");
			AddOpcode(0x49, "OP_49", "PPPPPP");
			AddOpcode(0x4A, "OP_4A", "PPPP");
			AddOpcode(0x4B, "OP_4B", "PPPPPP");
			AddOpcode(0x4C, "OP_4C", "PPPP");
			AddOpcode(0x4D, "OP_4D", "PPPP");
			AddOpcode(0x4E, "OP_4E", "PPPP");

			// 50-91
			AddOpcode(0x51, "UNK_51", "PP");
			AddOpcode(0x52, "UNK_52", "P");
			AddOpcode(0x53, "UNK_53", "PPPPP");
			AddOpcode(0x54, "UNK_54", "vP");
			AddOpcode(0x55, "UNK_55", "vP");
			AddOpcode(0x56, "UNK_56", "v");
			AddOpcode(0x57, "UNK_57", "PPPPP");
			AddOpcode(0x58, "UNK_58", "");
			AddOpcode(0x59, "UNK_59", "PPP");
			...
			AddOpcode(0x75, "UNK_75", "P");
			AddOpcode(0x76, "UNK_76", "PPP");
			AddOpcode(0x77, "UNK_77", "PP");
